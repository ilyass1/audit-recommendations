...
enum priority{
 ...
 enum status{
    mise_en_oeuvre("mise en oeuvre"),en_cours("en cours"),non_mise_en_oeuvre("non mise en oeuvre"),obsolete("obsolète");
...
public class recommendation  {
    ...
    public recommendation(String intitule, Date mise_en_place_previsionnelle, Date mise_en_place_reelle, Utilisateur responsable_mise_en_place, status status, priority priority, Integer Taux_avancement, List<domaine> domaine) {
