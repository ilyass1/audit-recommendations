...
export class utilisateur_data{
    ...
    update_utilisateur(id_user:number,name:string,prenom:string,type:string,id:number){
        const data = {id:id_user,nom:name,prenom:prenom,type:type,structure:{id:id}}
      this.http 
