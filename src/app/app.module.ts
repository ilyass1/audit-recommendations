...
@NgModule({
  ...
  imports: [
    ...
    HttpClientModule,
    TableModule,
    ButtonModule,DialogModule,FormsModule,BrowserAnimationsModule,
    SidebarModule,
    DropdownModule,
    SliderModule,
    ToastModule,
  ...
  providers: [utilisateur_data,mission_data,programme_data,structure_data,domaine_data,recommendation_data,MessageService,Globals],
