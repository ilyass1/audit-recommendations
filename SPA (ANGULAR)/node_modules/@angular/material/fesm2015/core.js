...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatCommonModule, [{
        ...
        args: [{
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { constructor: [], _hasDoneGlobalChecks: [], _document: [], _sanityChecks: [], _getDocument: [], _getWindow: [], _checksAreEnabled: [], _isTestEnv: [], _checkDoctypeIsDefined: [], _checkThemeIsPresent: [], _checkCdkVersionMatch: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MatRipple, [{
        ...
        args: [{
            ...
            }] }]; }, { constructor: [], _elementRef: [], _animationMode: [], radius: [{
            type: Input,
