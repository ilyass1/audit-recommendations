...
public class Mission {
    ...
    public Mission(String nom, List<domaine> perimetre, String Objectifs, Date debut, Date fin, List<recommendation> recommendations, String observations, List<Utilisateur> equipe_audit) {
        this.nom = nom;
