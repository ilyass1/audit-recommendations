...
Responsable_opérationel("responsable opérationel"),
...
class PriorityJpaConverter implements AttributeConverter<Type, String> {
   ...
   public String convertToDatabaseColumn(Type priority) {
       switch (priority) {
            case Auditeur_interne: return "Auditeur interne";
            case Responsable_opérationel: return "Responsable opérationel";
            case Responsable_audit : return "Responsable audit";
            default:
   ...
   public Type convertToEntityAttribute(String string) {
       switch (string) {
            case "Auditeur interne" : return Type.Auditeur_interne;
            case "Responsable opérationel" : return Type.Responsable_opérationel;
            case "Responsable audit" : return Type.Responsable_audit;
        }
